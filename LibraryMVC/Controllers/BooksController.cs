...
namespace LibraryMVC.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var libraryMVCContext = _context.Book.Include(b => b.Author);
        ...
        public async Task<IActionResult> Create([Bind("ISBN,Title,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ISBN,Title,AuthorId")] Book book)
        {
            if (id != book.ISBN)
            {
                return NotFound();
